...
\end{enumerate}
\begin{figure}[!h]
\includegraphics[height=3cm]{images/bidabad}
...
\end{enumerate}
\begin{figure}
\centering\includegraphics[scale=.6]{images/bibref}
...
\begin{figure}[!h]
\centerline{\includegraphics[width=.5\textwidth]{images/Xindy_Make_Index.png}}
